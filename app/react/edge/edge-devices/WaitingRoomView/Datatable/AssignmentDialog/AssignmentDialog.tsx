...
import { useCreateAndAssign } from './useCreateAndAssign';
...
export function AssignmentDialog({
  ...
  const { isLoading, onSubmit: createAndAssign } = useCreateAndAssign(
    environments,
    () => onSubmit(true)
  );
        ...
        {({ values, setFieldValue, errors }) => (
          <Form noValidate>
            ...
            <Modal.Footer>
              ...
              <LoadingButton isLoading={isLoading} loadingText="Associating...">
                Associate
              </LoadingButton>
            </Modal.Footer>
          </Form>
